...
function Item.evaluateCache(player, cacheFlag)
	...
	then
		if player:HasCollectible(CollectibleType.COLLECTIBLE_SOY_MILK) then
			player.Damage = player.Damage + (0.01 * SaveData.ItemData.RavenBeak.DMG * 0.2)
		elseif player:HasCollectible(CollectibleType.COLLECTIBLE_ALMOND_MILK) then
			player.Damage = player.Damage + (0.01 * SaveData.ItemData.RavenBeak.DMG * 0.33)
		else
			player.Damage = player.Damage + (0.01 * SaveData.ItemData.RavenBeak.DMG)
		end
	end
end
			...
			then
				if pickup.Variant == PickupVariant.PICKUP_HEART then
					if pickup.SubType == HeartSubType.HEART_ETERNAL then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 25
					...
					then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 15
					elseif pickup.SubType == HeartSubType.HEART_SOUL then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 10
					elseif pickup.SubType == HeartSubType.HEART_BLENDED then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 7
					elseif pickup.SubType == HeartSubType.HEART_HALF_SOUL then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 5
					elseif pickup.SubType == HeartSubType.HEART_DOUBLEPACK then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 4
					elseif pickup.SubType == HeartSubType.HEART_FULL
					or pickup.SubType == HeartSubType.HEART_ROTTEN
					then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 2
					else
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 1
					end
				elseif pickup.Variant == PickupVariant.PICKUP_COIN then
					...
					elseif pickup.SubType == CoinSubType.COIN_LUCKYPENNY then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 8
				...
				elseif pickup.Variant == PickupVariant.PICKUP_KEY then
					if pickup.SubType == KeySubType.KEY_GOLDEN then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 12
				...
				elseif pickup.Variant == PickupVariant.PICKUP_BOMB then
					if pickup.SubType == BombSubType.BOMB_GIGA then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 50
				...
				elseif pickup.Variant == PickupVariant.PICKUP_TRINKET then
					if pickup.SubType > TrinketType.TRINKET_GOLDEN_FLAG then
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 16
					else
						SaveData.ItemData.RavenBeak.DMG = SaveData.ItemData.RavenBeak.DMG + 8
					end
				end
