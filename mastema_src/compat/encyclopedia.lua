	...
	local Wiki = {
		...
		MASTEMA_B = {
			...
			{ -- Traits
				...
				{str = "Quality 0 and 1 items add 1 broken heart, quality 2 and 3 items add 2 broken hearts, and quality 4 items add 3 broken hearts."},
				{str = "Quest, food (Breakfast, Dinner, etc), and active items won't add any broken hearts."},
