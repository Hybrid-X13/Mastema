if EID then
	...
	EID:addCollectible(Enums.Collectibles.RAVEN_BEAK, "Consumes all pickups in the room and grants a small, permanent damage up for each pickup consumed#Higher quality pickups give more damage", "Raven Beak")
	...
	EID:addCollectible(Enums.Collectibles.TORN_WINGS, "{{DevilRoom}} Whenever an item spawns, there's a 25% chance it'll be pulled from the devil room pool instead#{{Tears}} Tears up for each item that grants flight#!!! Prevents flight for the rest of the run", "Torn Wings")
